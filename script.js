...
const account2 = {
    ...
    movementsDates: [
        ...
        '2022-08-26T14:43:26.374Z',
        '2022-08-30T18:49:59.371Z',
        '2022-08-31T12:01:20.894Z',
    ],
    currency: 'USD',
    locale: 'en-US',
};
...
const formattedDateMovement = function(date, locale) {
...
const displayMovements = function(acc, sort = false) {
    ...
    movs.forEach(function(mov, i) {
        ...
        const displayDate = formattedDateMovement(date, acc.locale)
...
const setTimer = function() {
    const tick = function() {
        ...
        if (time === 0) {
            clearInterval(timer)
            labelWelcome.textContent = `Login to countinue`;
